...
import { generateChatRoom, setMediaType, formatProjectId } from '../../utils/project'
  ...
  return (
    <Formik
      initialValues={{
        ...
        media: '',
        goal: manifest.goal,
        goalToken: manifest.goalToken.toLowerCase(),
        isPlaying: manifest.isPlaying,
...
function UpdateProject({ match, classes, history }) {
...
const StyledProject = withStyles(styles)(UpdateProject)
